...
nslider bounds(268, 14, 35, 15), channel("rise1_{pname}"), range(0.01, 50.0, 0.01), visible(1), identchannel("rise1_{pname}_id")
nslider bounds(306, 14, 35, 15), channel("fall1_{pname}"), range(0.01, 50.0, 0.5), visible(1), identchannel("fall1_{pname}_id")
...
nslider bounds(268, 36, 35, 15), channel("rise2_{pname}"), range(0.01, 50.0, 0.01), visible(1), identchannel("rise2_{pname}_id")
hslider bounds(268, 34, 75, 15), channel("lowpass2_{pname}"), range(0.01, 10.0, 5.0, 0.35), visible(0), identchannel("lowpass2_{pname}_id")
nslider bounds(306, 36, 35, 15), channel("fall2_{pname}"), range(0.01, 50.0, 0.5), visible(1), identchannel("fall2_{pname}_id")
