...
;checkbox bounds(650, 8, 12, 12), text("solo"), channel("solo_parm1"), colour("yellow"), value(0)
...
;checkbox bounds(650, 8, 12, 12), text("solo"), channel("solo_parm2"), colour("yellow"), value(0)
