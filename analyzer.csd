...
nslider bounds(290, 43, 60, 15), channel("pitch_high"), range(50, 2000, 800)
nslider bounds(290, 64, 60, 15), channel("pitch_low"), range(50, 2000, 150)
...
nslider bounds(270, 375, 40, 15), channel("plot_x_scale"), range(0.0, 99.0, 1.0)
nslider bounds(320, 375, 40, 15), channel("plot_x_offset"), range(-1.0, 1.0, 0.0)
...
nslider bounds(270, 455, 40, 15), channel("plot_y_scale"), range(0.0, 99, 1.0)
nslider bounds(320, 455, 40, 15), channel("plot_y_offset"), range(-1.0, 1.0, 0.0)
...
nslider bounds(270, 535, 40, 15), channel("plot_c_scale"), range(0.0, 99, 1.0)
