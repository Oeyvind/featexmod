...
nslider bounds(290, 43, 60, 15), channel("pitch_high"), range(50, 2000, 800), fontSize(12)
nslider bounds(290, 64, 60, 15), channel("pitch_low"), range(50, 2000, 150), fontSize(12)
...
button bounds(40, 295, 50, 15), channel("plotenable"), text("not","plot"), value(0), colour("grey"), fontColour("lightblue")
button bounds(90, 295, 50, 15), channel("plotclear"), text("clear","-"), value(0), colour("grey"), fontColour("lightblue"), latched(0)
...
nslider bounds(290, 295, 40, 15), channel("plotmetrorate"), range(1, 50, 10), fontSize(12)

label text("x"), bounds(270, 315, 15, 15), align("left")
; >>>>>>> AUTOGENERATED TEXT_x_: DO NOT EDIT THE FOLLOWING LINES >>>>>>>
combobox channel("plot_x"), bounds(270, 332, 90, 18), items("rms", "rms_dB", "transient", "trans_dens", "env_crest", "env_dyn", "pitch", "s_centroid", "s_spread", "s_skewness", "s_kurtosis", "s_flatness", "s_crest", "s_flux", "rhythm_irreg", "rhythm_cons", "rhyt_con_dev", "ra_flux", "ra_crest", "mfcc1", "mfcc2", "mfcc3", "mfcc_diff"), value(1)
; <<<<<<< AUTOGENERATED TEXT_x_: DO NOT EDIT THE PRECEDING LINES <<<<<<<
label text("scale  offset"), bounds(270, 352, 90, 15), align("left")
nslider bounds(270, 375, 40, 15), channel("plot_x_scale"), range(0.0, 99.0, 1.0), fontSize(12)
nslider bounds(320, 375, 40, 15), channel("plot_x_offset"), range(-1.0, 1.0, 0.0), fontSize(12)

label text("y"), bounds(270, 395, 15, 15), align("left")
; >>>>>>> AUTOGENERATED TEXT_y_: DO NOT EDIT THE FOLLOWING LINES >>>>>>>
combobox channel("plot_y"), bounds(270, 412, 90, 18), items("rms", "rms_dB", "transient", "trans_dens", "env_crest", "env_dyn", "pitch", "s_centroid", "s_spread", "s_skewness", "s_kurtosis", "s_flatness", "s_crest", "s_flux", "rhythm_irreg", "rhythm_cons", "rhyt_con_dev", "ra_flux", "ra_crest", "mfcc1", "mfcc2", "mfcc3", "mfcc_diff"), value(1)
; <<<<<<< AUTOGENERATED TEXT_y_: DO NOT EDIT THE PRECEDING LINES <<<<<<<
label text("scale  offset"), bounds(270, 432, 90, 15), align("left")
nslider bounds(270, 455, 40, 15), channel("plot_y_scale"), range(0.0, 99, 1.0), fontSize(12)
nslider bounds(320, 455, 40, 15), channel("plot_y_offset"), range(-1.0, 1.0, 0.0), fontSize(12)

label text("c"), bounds(270, 475, 15, 15), align("left")
; >>>>>>> AUTOGENERATED TEXT_c_: DO NOT EDIT THE FOLLOWING LINES >>>>>>>
combobox channel("plot_c"), bounds(270, 492, 90, 18), items("rms", "rms_dB", "transient", "trans_dens", "env_crest", "env_dyn", "pitch", "s_centroid", "s_spread", "s_skewness", "s_kurtosis", "s_flatness", "s_crest", "s_flux", "rhythm_irreg", "rhythm_cons", "rhyt_con_dev", "ra_flux", "ra_crest", "mfcc1", "mfcc2", "mfcc3", "mfcc_diff"), value(1)
; <<<<<<< AUTOGENERATED TEXT_c_: DO NOT EDIT THE PRECEDING LINES <<<<<<<
label text("scale  offset"), bounds(270, 512, 90, 15), align("left")
nslider bounds(270, 535, 40, 15), channel("plot_c_scale"), range(0.0, 99, 1.0), fontSize(12)
nslider bounds(320, 535, 40, 15), channel("plot_c_offset"), range(-1.0, 1.0, 0.0), fontSize(12)
